...
function ShrPicker(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, props.label && /*#__PURE__*/_react.default.createElement(_Label.default, props), /*#__PURE__*/_react.default.createElement(_reactNative.Pressable, {
  ...
  }, props.children)), /*#__PURE__*/_react.default.createElement(_reactNative.Modal, {
    transparent: true,
    visible: showPicker
...
const styles = _reactNative.StyleSheet.create({
  ...
  childIconWrapper: {
    backgroundColor: _colors.colors.faintBlue,
    alignSelf: 'stretch',
    justifyContent: 'center',
    alignItems: 'stretch',
    borderLeftWidth: 1,
    borderColor: _colors.colors.faintBlue,
    padding: 8,
