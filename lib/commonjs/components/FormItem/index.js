...
var _ShowTextIcon = _interopRequireDefault(require("../_icons/ShowTextIcon"));
...
const FormItem = /*#__PURE__*/(0, _react.forwardRef)((_ref, ref) => {
  let {
    children,
    ...props
  } = _ref;
  ...
  const [hideText, setHideText] = (0, _react.useState)(props.secureTextEntry);
  ...
  (0, _react.useEffect)(() => {
    if (props.floatingLabel && props.value) _reactNative.Animated.timing(animatedBottom, {
      toValue: props.textArea ? 24 : wrapperHeight / 2,
      useNativeDriver: false,
      duration: 300
    }).start(() => setShouldAnimate(false));
  ...
  if (props.floatingLabel) {
    ...
    })), hasError.status && props.showErrorIcon && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      style: styles.errorWrapper,
      testID: "error icon wrapper"
    }, /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
      style: styles.exclamation
    }, '\u0021')), props.secureTextEntry && !hasError.status && /*#__PURE__*/_react.default.createElement(_reactNative.Pressable, {
      onPress: () => setHideText(!hideText)
    }, /*#__PURE__*/_react.default.createElement(_ShowTextIcon.default, {
      hide: hideText,
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, null, props.label && /*#__PURE__*/_react.default.createElement(_Label.default, {
    text: props.label,
...
FormItem.defaultProps = {
  showErrorIcon: true,
  errorBorderColor: _colors.colors.red
};
