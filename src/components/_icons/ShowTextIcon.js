...
export default function ShowTextIcon(props) {
    if (props.showIcon && !props.hide)
        return props.showIcon;
    if (props.hideIcon && props.hide)
        return props.hideIcon;
    return (React.createElement(View, null,
        React.createElement(View, { style: styles.eye },
            React.createElement(View, { style: styles.circle },
                React.createElement(View, { style: styles.dot }))),
        props.hide && React.createElement(View, { style: styles.line })));
}
